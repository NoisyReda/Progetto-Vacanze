 ...
 * @author Mattia
 */
public class Sacchetti extends javax.swing.JFrame {

    /**
     * Creates new form Sacchetti
     */
    public Sacchetti() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digitare il numero di sacchetti usati");
        ...
        jLabel2.setText("Acquisto sacchetti");
        ...
        jButton5.getAccessibleContext().setAccessibleName("0");

        jButton6.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        jButton6.setText("AIUTO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Dati.getInstance().setTotale(Dati.getInstance().getTotale() + (float) 0.10);
        this.setVisible(false);
        Arrivederci a = new Arrivederci();
        a.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Dati.getInstance().setTotale(Dati.getInstance().getTotale() + (float) 0.20);
        this.setVisible(false);
        Arrivederci a = new Arrivederci();
        a.setVisible(true);
        Dati.getInstance().Reset();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Dati.getInstance().setTotale(Dati.getInstance().getTotale() + (float) 0.30);
        this.setVisible(false);
        Arrivederci a = new Arrivederci();
        a.setVisible(true);
        Dati.getInstance().Reset();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        JOptionPane.showMessageDialog(new JFrame(), "Scegliere il numero di sacchetti da utilizzare", "Help", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sacchetti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
